                    ...
                    <div class="form-row">
                       ...
                       <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Type<span>*</span></label>
                         <input type="hidden" name="conferenceId;" class="form-control" id="conferenceId;" value="${Conference.id}" >
                         <input type="readonly" name="type" class="form-control" id="type" minlength="1" maxlength="50" value="${Conference.type;}" >
                      </div>  
                                          
                       <div class="col-md-8 mb-4 input-field">
                        <label for="validationCustom02">Name of the Conference<span>*</span></label>
                             <input type="text" name="nameOfConference" class="form-control form-control-sm" id="nameOfConference" minlength="1" maxlength="200" value="${Conference.nameOfConference}">
                       </div>
                    ...
                    <div class="form-row">
                       ...
                       <div class="col-md-12 mb-6 input-field">
                        <label for="validationCustom02">Acronym<span>*</span></label>
                             <input type="text" name="acronym" class="form-control form-control-sm" id="acronym" minlength="1" maxlength="200" value="${Conference.acronym}">
                       </div>
                    ...
                    <div class="form-row">
                       ...
                       <div class="col-md-12 mb-6 input-field">
                        <label for="validationCustom02">Web Page<span>*</span></label>
                         <input type="text" name="webPage" class="form-control" id="webPage" minlength="1" maxlength="200" required value="${Conference.webPage}"  >
                      </div> 
                 ...
                 <!-- ================================= -->
                    <div class="form-row">
                     ...
                     <div class="col-md-12 mb-6 input-field">
                        <label for="validationCustom02">Venue</label>
                         <input type="text" name="venue" class="form-control" id="venue" minlength="1" maxlength="200"  value="${Conference.venue}"  >
                      </div> 
                    ...
                    <div class="form-row">
                     ...
                     <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">City<span>*</span></label>
                         <input type="text" name="city" class="form-control" id="city" minlength="1" maxlength="150" required value="${Conference.city}"  >
                      </div> 
                      
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Country/region<span>*</span></label>
                         <input type="text" name="country" class="form-control" id="country" minlength="1" maxlength="50" required value="${Conference.country}"  >
                      </div> 
                      
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Estimated number of Submission<span>*</span></label>
                         <input type="text" name="estimatedNoOfSubmission" class="form-control" id="estimatedNoOfSubmission" minlength="1" maxlength="10" required value="${Conference.estimatedNoOfSubmission}"  onkeypress="return fieldNumberCheck(this,10)" onpaste="return pasteFunction(this)">
                      </div> 
                    ...
                    <div class="form-row">
                     ...
                     <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Conference Start Date<span>*</span></label>
                         <input type="date" name="startDt" class="form-control" id="startDt" minlength="1" maxlength="50" required value="${Conference.startDt}"  >
                      </div> 
                      
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Conference End Date<span>*</span></label>
                         <input type="date" name="endDt" class="form-control" id="endDt" minlength="1" maxlength="50" required value="${Conference.endDt}"  >
                      </div> 
                      
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Deadline of Paper Submission<span>*</span></label>
                         <input type="date" name="paperSubmissionDeadline" class="form-control" id="paperSubmissionDeadline" minlength="1" maxlength="50" required value="${Conference.paperSubmissionDeadline}"  >
                      </div> 
                       ...
                       <!-- ================================= -->
	                    ...
	                    <div class="form-row">
	                        ...
	                        <label for="validationCustom02">Area Notes<span>*</span></label>
	                        	<textarea  class="form-control" name="areaNote"  id="areaNote" maxlength="4000" value="${Conference.areaNote}" rows="4" cols="100" required >${Conference.areaNote}</textarea>
	                        </div> 
                    ...
                    <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Organizer<span>*</span></label>
                         <input type="text" name="organizer" class="form-control" id="organizer" minlength="1" maxlength="100" required value="${Conference.organizer}"  >
                      </div> 
                   
                     <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Contact Phone Number<span>*</span></label>
                         <input type="text" name="contactNo" class="form-control" id="contactNo" minlength="1" maxlength="10" required value="${Conference.contactNo}" onkeypress="return fieldNumberCheck(this,10)" onpaste="return pasteFunction(this)" >
                      </div> 
                      
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Your Role<span>*</span></label>
                         <input type="text" name="yourRole" class="form-control" id="yourRole" minlength="1" maxlength="50"  value="${Conference.yourRole}"  >
                      </div> 
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Organizer Web page<span>*</span></label>
                         <input type="text" name="organizerWebPage" class="form-control" id="organizerWebPage" minlength="1" maxlength="200" required value="${Conference.organizerWebPage}"  >
                      </div> 
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-12 mb-6 input-field">
                        <label for="validationCustom02">Any Other Information</label>
                       		<textarea  class="form-control" name="anyOtherDetail"  id="anyOtherDetail" maxlength="4000" value="${Conference.anyOtherDetail}" rows="4" cols="100" required >${Conference.anyOtherDetail}</textarea>
	                    </div> 
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Evaluation Parameters created by Chair activated for Jury</label>
                         <input type="text" name="evaluationParameterMarksForJury" class="form-control" id="evaluationParameterMarksForJury" minlength="1" maxlength="3" required value="${Conference.evaluationParameterMarksForJury}" onkeypress="return fieldNumberCheck(this,3)" onpaste="return pasteFunction(this)" >
                      </div> 
                      
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Evaluation Parameters created by Chair activated for Chair</label>
                         <input type="text" name="evaluationParameterMarksForChair" class="form-control" id="evaluationParameterMarksForChair" minlength="1" maxlength="3" required value="${Conference.evaluationParameterMarksForChair}" onkeypress="return fieldNumberCheck(this,3)" onpaste="return pasteFunction(this)" >
                      </div> 
                     ...
                     <fieldset class="card sub_fielfset" id="studentFieldset">
					         ...
					         <div class="card table_card">
					               <div class="card-header">
						                 ...
						                 <div>
						                 	<c:if test="${(Conference.status==''||Conference.status=='Drafted')}">
                    ...
                    <div class="form-row" id="configRight">                   
                      ...
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Display Review Comment To Author</label>
                        	<select  class="form-control" name="displayReviewCommentToAuthor" id="displayReviewCommentToAuthor" maxlength="20" value="${extraActivity.displayReviewCommentToAuthor}"  >		                   		
                      ...
                      <div class="col-md-4 mb-2 input-field">
                        <label for="validationCustom02">Enable Email Notification To Author</label>
                     	<select  class="form-control" name="emailNotificationToAuthor" id="emailNotificationToAuthor" maxlength="20" value="${extraActivity.emailNotificationToAuthor}"  >		                   		
		                   		<option value="" >Choose ..</option>
		                   		<option value="Yes" >Yes</option>
		                   		<option value="No">No</option>		                   	
		                   	</select>	                        
